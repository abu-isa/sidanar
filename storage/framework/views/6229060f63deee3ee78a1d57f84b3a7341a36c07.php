...
<html>
	...
	<body id="top">
		...
		<section id="one" class="wrapper style1">
			...
			<div class="container">
				<div class="row">
					<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seminar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<div class="4u">
							<section class="special box">
								<i class="icon fa-area-chart major"></i>
								<h3><?php echo e($seminar->judul); ?></h3>
								<p><?php echo e($seminar->tanggal); ?></p>
							</section>
						</div>
...
</html><?php /**PATH D:\sidanar\resources\views/halamandepan.blade.php ENDPATH**/ ?>