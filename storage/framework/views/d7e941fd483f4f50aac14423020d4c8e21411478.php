...
<div class="wrapper">
	...
	<div class="form">
		<?php $__currentLoopData = $form; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<div class="inputfield">
				<label class="control-label col-sm-2">Nama</label>
				<input type="text" class="input form-control" value="<?php echo e($user->name); ?>" readonly>
			</div>
			<div class="inputfield">
				<label class="control-label col-sm-2">Email</label>
				<input type="text" class="input form-control" value="<?php echo e($user->email); ?>" readonly>
			</div>
			<div class="inputfield">
				<label class="control-label col-sm-2">Nomor Telepon</label>
				<input type="text" class="input form-control" value="<?php echo e($user->mobile_number); ?>" readonly>
			</div>
		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

		<?php $__currentLoopData = $seminar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seminarhasil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<div class="inputfield">
				<label class="control-label col-sm-2">Nama Seminar</label>
				<input type="text" class="input form-control" value="<?php echo e($seminarhasil->judul); ?>" readonly>
			</div>
			<div class="inputfield">
				<label class="control-label col-sm-2">Tanggal Seminar</label>
				<input type="text" class="input form-control" value="<?php echo e($seminarhasil->tanggal); ?>" readonly>
			</div>
			<div class="inputfield">
				<label class="control-label col-sm-2">Harga Seminar</label>
				<input type="text" class="input form-control" value="<?php echo e($seminarhasil->harga); ?>" readonly>
			</div>
		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            document.getElementById('pay-button').onclick = function(){
                snap.pay('<?php echo $snapToken?>', {
                    onSuccess: function(result){
                        ...
                        window.location.href = "homesuccess/<?php echo e($user->id); ?>";
                    },
                    onPending: function(result){
                        document.getElementById('result-json').innerHTML += JSON.stringify(result, null, 2);
                        window.location.href = "homepending/<?php echo e($user->id); ?>";
                        // $.ajax({
                        //     url:'save',
                        //     dataType:"json",
                        //     method: "POST",
...
<!--<div class="inputfield">
	...
	</div> --><?php /**PATH D:\sidanar\resources\views/confirmationpage.blade.php ENDPATH**/ ?>